...
from models.domain import (
    OrderIntent, OrderSide, OrderType, OrderResult, OrderStatus, 
    Position, ReconciliationResult, ReconciliationMismatch
)
...
def test_order_repository_duplicate_order(mock_supabase):
    ...
    mock_supabase.table.return_value.insert.side_effect = MockAPIError("23505 duplicate key")
...
def test_order_repository_fills(mock_supabase):
    ...
    mock_supabase.table.return_value.update.assert_called_with({"status": "PARTIALLY_FILLED"})
