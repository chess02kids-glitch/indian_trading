...
def test_cli_ingest_symbol(mock_pipeline):
    ...
    mock_pipeline.return_value.ingest_symbol.assert_called_once_with("RELIANCE.NS", period="1mo")
...
def test_cli_ingest_universe(mock_pipeline):
    ...
    mock_pipeline.return_value.ingest_universe.assert_called_once_with(["RELIANCE.NS", "TCS.NS"], period="max")
