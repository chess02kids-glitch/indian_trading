...
_LAZY_EXPORTS = {
    ...
    "ResearchCampaignStore": ("research.campaign", "ResearchCampaignStore"),
    "ResearchBudgetExhausted": ("research.campaign", "ResearchBudgetExhausted"),
    "ResearchHypothesis": ("research.hypothesis", "ResearchHypothesis"),
    "novelty_check": ("research.hypothesis", "novelty_check"),
    "instantiate": ("research.registry", "instantiate"),
    "canonical_strategy": ("research.registry", "canonical_strategy"),
    "BENCHMARK_ZOO": ("research.registry", "BENCHMARK_ZOO"),
    "submit_hypothesis": ("research.ai_boundary", "submit_hypothesis"),
    "build_research_context": ("research.ai_boundary", "build_research_context"),
    "build_world": ("research.worlds", "build_world"),
    "rank_eligible": ("research.pit", "rank_eligible"),
